...
public class ClassCalculation
{
    public static class Map extends Mapper<Object, Text, Text, IntWritable>
    {
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException
        {
            ...
            while (token.hasMoreTokens())
            {
                ...
                {
                    // The course and class as key, score as value.
                    context.write(new Text(attributes[StudentAttr.COURSE.ordinal()] + "," +
                                    attributes[StudentAttr.CLASS.ordinal()]),
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException
    {
        ...
        job.setJarByClass(ClassCalculation.class);
